...
class Train:
    ...
    def test_per_epoch(self, dataloader, loss_meter, acc_meter):
        ...
        return [auc,specificity] + list(metric) + recall,self.model.attention_list[1].dec.assignment.cluster_centers.detach().cpu().numpy()
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            test_result, weight = self.test_per_epoch(self.test_dataloader,
        ...
        return [best_test_acc,best_test_AUC,best_test_sen,best_test_spec,\
                best_test_recall, best_test_precision,attn]